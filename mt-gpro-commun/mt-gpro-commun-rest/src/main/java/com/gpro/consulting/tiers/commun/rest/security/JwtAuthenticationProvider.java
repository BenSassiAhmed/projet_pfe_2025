...
//return new AuthenticatedUser(parsedUser.getId(), parsedUser.getUserName(), token, authorityList,parsedUser.getRoles());
        return new AuthenticatedUser(parsedUser.getId(), parsedUser.getUserName(),parsedUser.getFirstName(),parsedUser.getLastName(),parsedUser.getEmail(),parsedUser.getJob(), token, authorityList,parsedUser.getRoles());
    }
}