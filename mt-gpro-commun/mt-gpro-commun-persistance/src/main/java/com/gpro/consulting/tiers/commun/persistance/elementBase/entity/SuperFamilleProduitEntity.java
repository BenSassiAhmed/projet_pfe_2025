...
/**
 * The Class super FamilleProduitEntity.
 * @author med
 */
@Entity
@Table(name=IConstante.TABLE_SUPER_FAMILLE_PRODUIT)
public class SuperFamilleProduitEntity implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 4530593320304862883L;

	/** The id. */
	@Id
	@SequenceGenerator(name="FAMILLEPROD_ID_GENERATOR", sequenceName=IConstante.SEQUENCE_SUPER_FAMILLE_PRODUIT)
