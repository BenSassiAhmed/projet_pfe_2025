 ...
 */
@Entity
@Table(name=IConstante.TABLE_COMPTE_COMPTABLE)
public class CompteComptableEntity implements Serializable{
	...
	/** The id. */
	@Id
	@SequenceGenerator(name="COMPTE_COMPTABLE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_COMPTE_COMPTABLE,allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="COMPTE_COMPTABLE_ID_GENERATOR")
	private Long id;
