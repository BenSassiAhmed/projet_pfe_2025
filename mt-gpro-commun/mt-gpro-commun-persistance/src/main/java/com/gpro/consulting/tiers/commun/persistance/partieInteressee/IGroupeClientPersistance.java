...
public interface IGroupeClientPersistance {
	...
	public String modifierGroupeClient(
			GroupeClientValue pGroupeClientValue);

	/********************** recherche categorie partie interesse par Id *****************************/
	public GroupeClientValue rechercheGroupeClientParId(
			GroupeClientValue pGroupeClientValue);
