 ...
 */
@Entity
@Table(name=IConstante.TABLE_IMPRESSION_PRODUIT)
public class ImpressionProduitEntity implements Serializable{


	/**
	 * 
	 */
	private static final long serialVersionUID = 3883230003814899641L;

	/** The id. */
	@Id
	@SequenceGenerator(name="IMPRESSION_PRODUIT_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_IMPRESSION_PRODUIT,allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="IMPRESSION_PRODUIT_ID_GENERATOR")
	private Long id;
