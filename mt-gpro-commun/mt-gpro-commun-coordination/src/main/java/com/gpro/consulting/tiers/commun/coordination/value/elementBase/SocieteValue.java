...
public class SocieteValue { 
  ...
  /** The actif. */
   private Boolean actif;
	...
	private List<BoutiqueValue> boutiques;
   ...
   public List<BoutiqueValue> getBoutiques() {
		return boutiques;
	}


	public void setBoutiques(List<BoutiqueValue> boutiques) {
...
public SocieteValue() {
	...
	public SocieteValue(Long boutiqueId) {
