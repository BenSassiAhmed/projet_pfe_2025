...
!(function(e) {
  var t = 33,
    i = (function() {
      function e() {}
      return (
        (e.transition = function(t, i) {
          var n = { element: t, props: i, transformations: {} };
        ...
        (e.animation = function(t, i, n) {
          var s = { element: t, keyframes: i, props: n };
        ...
        (e.scrollTo = function(t, i) {
          var n = { element: t, props: i, step: 0 };
          e._setScrollProperties(n),
            n.props.delay
              ? setTimeout(e._animationObjects, 1e3 * n.props.delay, n)
              : e._animateScroll(n),
            e._animationObjects.push(n);
        }),
        ...
        (e._animateScroll = function(i) {
          ...
          (i.element.scrollTop = s),
            i.step >= n
              ? ((i.element.scrollTop = i.props.top),
        ...
        (e._createTransition = function(t) {
          var i = t.duration || 0,
            n = t.delay || 0;
          (t.element.style.transitionProperty = e._getTransitionProperties(
            t.tweenObj
          )),
        ...
        (e._getTransitionProperties = function(t) {
          ...
          for (var o in t)
            e._contains(e._transformProps, o)
              ...
              ? (n = !0)
              : s.push(e._camelCaseToDash(o));
          return (
            i && s.push("transform"),
            n && (s.push("-webkit-filter"), s.push("filter")),
            s.join(", ")
          );
        }),
        (e._setProperties = function(t) {
          for (var i in t.tweenObj)
            e._contains(e._transformProps, i)
              ? e._setTransformValues(t, i)
              : e._contains(e._filters, i)
              ? e._setFilterValues(t, i)
              : e._setRegularValues(t, i);
        ...
        (e._setRegularValues = function(e, t) {
          ...
          i.toString().indexOf("%") === -1 &&
            (i +=
              "opacity" !== t && "backgroundColor" !== t && "boxShadow" !== t
                ? "px"
                : ""),
            (e.element.style[t] = i);
        }),
        ...
        (e._contains = function(e, t) {
          for (var i = e.length; i--; ) if (t === e[i]) return !0;
          return !1;
        }),
  ...
  var t = (function() {
    ...
    return (
      ...
      (e.prototype._createItemCollection = function() {
        ...
        for (o; o < s; o++)
          (e = this._listItems[o].querySelector(".ms-Breadcrumb-itemLink")),
            ...
            this._itemCollection.push({ link: i, tabIndex: n, text: t });
      }),
      ...
      (e.prototype._openOverflow = function(e) {
        this._overflowMenu.className.indexOf(" is-open") === -1 &&
      ...
      (e.prototype._cacheDOM = function() {
        (this._breadcrumb = this.container),
          ...
          (this._contextMenu = this._breadcrumb.querySelector(
            ".ms-ContextualMenu"
          )),
    ...
    p = (function() {
      function e(t, i, o, r, a, c, h) {
        if (
          ...
          (this._contextualHostMain = this._contextualHost.getElementsByClassName(
            n
          )[0]),
      ...
      return (
        ...
        (e.prototype.createContainer = function() {
          ...
          return (
            i.setAttribute("class", s), e.appendChild(i), (e.innerHTML += ""), e
          );
        }),
        ...
        (e.prototype._setPosition = function(e) {
          ...
          switch (
            (this._matchTargetWidth &&
              (y = "width: " + this._modalWidth + "px;"),
            e)
          ) {
            case "left":
              (t = u - this._modalWidth - C),
                (n = this._calcTop(this._modalHeight, v, m)),
                (n += window.scrollY ? window.scrollY : 0),
                this._container.setAttribute(
                  "style",
                  "top: " + n + "px; left: " + t + "px;" + y
                ),
                this._container.classList.add(i),
                this._hasArrow &&
                  (this._container.classList.add(c),
                  (s = m + g - n + d),
            ...
            case "top":
              (t = this._calcLeft(this._modalWidth, this._teWidth, u)),
                ...
                this._container.classList.add(i),
                this._hasArrow &&
                  ((s = this._modalHeight - C / 2),
                  (l = Math.max(b + u - t + (f - C) / 2, d)),
            ...
            case "bottom":
              (t = t = this._calcLeft(this._modalWidth, this._teWidth, u)),
                ...
                this._hasArrow &&
                  ((l = Math.max(b + u - t + (f - C) / 2, d)),
                  this._arrow.setAttribute("style", "left: " + l + "px;"),
        ...
        (e.prototype._saveModalSize = function() {
          ...
          if (
            ...
            this._modalWidth =
              ...
              (parseInt(n.marginLeft, 10) + parseInt(n.marginLeft, 10));
          } else
            (this._modalWidth =
    ...
    return (
      ...
      (e.prototype._dispatchSelectEvent = function() {
        var e = {
          bubbles: !0,
          cancelable: !0,
          detail: { name: this._choiceField.getAttribute("name"), item: this }
        };
  ...
  var t = (function() {
    ...
    return (
      ...
      (t.prototype._initalSetup = function() {
        for (
          var t = this._choiceFieldGroup.querySelectorAll(".ms-RadioButton"),
            i = 0;
          i < t.length;
          i++
        )
    ...
    a = (function() {
      function e(e) {
        ...
        (this._container = e),
          ...
          (this._boundExpandSearchHandler = this._expandSearchHandler.bind(
            this
          )),
      ...
      return (
        ...
        (e.prototype._setHasText = function() {
          this._searchBoxField.value.length > 0
            ? this._searchBox.classList.add(s)
            : this._searchBox.classList.remove(s);
        }),
    ...
    o = (function() {
      function o(e, s) {
        (this._container = e),
          ...
          s
            ? (this._contextualMenu = s)
            : (this._contextualMenu = this._container.querySelector(t)),
          this._checkForMenu();
      }
      return (
        (o.prototype._createModalHostView = function() {
...
!(function(e) {
  ...
  var t = ".ms-ContextualMenu",
    ...
    m = (function() {
      ...
      return (
        (m.prototype._runsSearchBox = function(e) {
          void 0 === e && (e = "add"),
        ...
        (m.prototype._getScreenSize = function() {
          ...
          return (
            (t.x = e.innerWidth || n.clientWidth || s.clientWidth),
        ...
        (m.prototype._setElements = function() {
          var e = this;
          (this._elements = { mainArea: this._container.querySelector(o) }),
            this._container.querySelector(r) &&
              (this._elements.sideCommandArea = this._container.querySelector(
                r
              )),
            this._container.querySelector(a) &&
              ((this._elements.overflowCommand = this._container.querySelector(
                a
              )),
              (this._elements.contextMenu = this._container
                .querySelector(a)
                .querySelector(t))),
            this._container.querySelector(o + " " + s) &&
        ...
        (m.prototype._updateCommands = function() {
          ...
          for (var s = 0, o = 0; o < this.itemCollection.length; o++)
            (s += this.commandWidths[o]),
              s < n
                ? this.visibleCommands.push(this.itemCollection[o])
                : this.overflowCommands.push(this.itemCollection[o]);
        }),
        (m.prototype._drawCommands = function() {
          ...
          for (var e = 0; e < this.overflowCommands.length; e++) {
            ...
            if (
              ((i.innerText = this.overflowCommands[e].label),
              t.appendChild(i),
              n)
            ) {
        ...
        (m.prototype._processCollapsedClasses = function(e) {
          for (var t = 0; t < this.itemCollection.length; t++) {
            ...
            i.isCollapsed ||
              ("add" === e
                ? i.item.classList.add(c)
                : i.item.classList.remove(c));
          }
      ...
      return (
        ...
        (n.prototype._onDocumentClick = function(e) {
          ...
          this._hostTarget.contains(t) ||
            i.contains("ms-ContextualMenu-link") ||
            (this._isOpen = !1);
        }),
        ...
        (n.prototype._toggleMenu = function(e) {
          this._isOpen ? this._host.disposeModal() : this._openContextMenu(e),
...
!(function(e) {
  var t = (function() {
    function e(e, t) {
      var i = this,
        n = $(e),
        s = n.find(".ms-TextField-field").pickadate(
          $.extend(
            {
      ...
      (e.prototype.setDateAttributes = function(e) {
        ...
        return (
          ("undefined" != typeof t && null !== t) ||
            (t = this.picker.get("highlight").year),
          ("undefined" != typeof i && null !== i) ||
            (i = this.picker.get("highlight").month),
          ("undefined" != typeof n && null !== n) ||
            (n = this.picker.get("highlight").date),
          [t, i, n]
        );
      }),
      e
  ...
  var t = (function() {
    function t(e) {
      (this._dialog = e),
        ...
        (this._actionButtonElements = this._dialog.querySelectorAll(
          ".ms-Dialog-action"
        )),
...
!(function(e) {
  var t = "animate-in",
    ...
    s = (function() {
      ...
      return (
        (s.prototype.dismiss = function(e) {
          var t = this;
    ...
    u = (function() {
      function u(e) {
        (this._container = e),
          ...
          this._dropdownLabelHelper.classList.add(i),
          ...
          this._newDropdown.classList.add(s),
          (this._dropdownItems = []),
          (this._originalDropdown = e.querySelector(r));
        ...
        for (var a = 0; a < t.length; ++a) {
          ...
          h.classList.add(o),
            c.disabled && h.classList.add(l),
            (h.innerHTML = c.text),
            h.addEventListener("click", this._onItemSelection),
            this._newDropdown.appendChild(h),
            this._dropdownItems.push({ oldOption: c, newItem: h });
        }
      ...
      return (
        (u.prototype._setWindowEvent = function() {
          var e = this;
          window.addEventListener(
            "resize",
            function() {
        ...
        (u.prototype._checkTruncation = function() {
          var e = this._newDropdown.querySelector("." + h),
            t = e
              ? e.textContent
              : this._newDropdown.querySelectorAll("." + o)[0].textContent;
          if (
            ...
            do
              i--,
                (s = t.slice(0, i)),
                (this._dropdownLabelHelper.textContent = s + n);
            while (
              this._dropdownLabelHelper.offsetHeight >
              this._newDropdownLabel.offsetHeight
            );
        ...
        (u.prototype._openDropdownAsPanel = function() {
          void 0 === this._panel &&
            ...
            this._panelContainer.classList.add(c),
            this._panelContainer.classList.add(d),
        ...
        (u.prototype._closeOtherDropdowns = function() {
          for (
            var e = document.querySelectorAll("." + t + "." + c), i = 0;
            i < e.length;
            i++
          )
        ...
        (u.prototype._onItemSelection = function(e) {
          ...
          if (!i && !n) {
            for (var s = 0; s < this._dropdownItems.length; ++s)
              this._dropdownItems[s].newItem === t
                ? (this._dropdownItems[s].newItem.classList.add(h),
                  (this._dropdownItems[s].oldOption.selected = !0))
                : (this._dropdownItems[s].newItem.classList.remove(h),
    ...
    return (
      ...
      (t.prototype._onActionClick = function(e) {
        var t = e.target,
          i = t.getAttribute("data-action-id");
        i &&
          t.className.indexOf("is-active") === -1 &&
          (this._setAction(t), this._setDetail(i));
      }),
...
!(function(e) {
  var t = "top",
    i = (function() {
      ...
      return (
        (i.prototype._createPersonaCard = function() {
        ...
        (r.prototype._createPersonaCollection = function() {
          for (var r = document.querySelectorAll(t), a = 0; a < r.length; a++) {
            ...
            this._personaCollection.push({
              ...
              image: c.querySelector(n)
                ? c.querySelector(n).getAttribute("src")
                : null,
              primaryText: c.querySelector(s)
                ? c.querySelector(s).textContent
                : "",
              secondaryText: c.querySelector(o)
                ? c.querySelector(o).textContent
                : "",
...
!(function(e) {
  var t = (function() {
    function t(t) {
      ...
      for (
        var i = this._container.querySelectorAll(".ms-ListItem"), n = 0;
        n < i.length;
        n++
      )
  ...
  var t = (function() {
    ...
    return (
      ...
      (e.prototype._hideBanner = function() {
        this._errorBanner.className.indexOf("hide") === -1 &&
...
!(function(e) {
  var t = "bottom",
    ...
    n = (function() {
      ...
      return (
        (n.prototype._createModalHost = function(i) {
          i.stopPropagation(),
        ...
        (n.prototype._clickHandler = function(e) {
          ...
          i.parentNode.replaceChild(n, i),
            (this._peoplePickerResults = this._peoplePickerMenu.querySelectorAll(
              ".ms-PeoplePicker-result"
            ));
          for (var s = 0; s < this._peoplePickerResults.length; s++) {
            var o = this._peoplePickerResults[s].querySelector(".ms-Persona"),
              r = this._peoplePickerResults[s].querySelector(
        ...
        (n.prototype._selectResult = function(e) {
          ...
          this._container.classList.contains("ms-PeoplePicker--facePile")
            ? this._addResultToMembers(i)
            : this._tokenizeResult(i),
            this._updateCount(),
        ...
        (n.prototype._addRemoveBtn = function(e, t) {
          ...
          t
            ? ((i = document.createElement("div")),
              ...
              i.addEventListener("click", this._removeToken.bind(this), !0))
        ...
        (n.prototype._addResultToMembers = function(e) {
          ...
          n.classList.add("ms-PeoplePicker-selectedPerson"),
            ...
            n
              ...
              .addEventListener("click", this._removeResult.bind(this), !0),
            t.insertBefore(n, i);
        }),
    ...
    return (
      ...
      (e.prototype._addListeners = function() {
        ...
        this._container
          ...
          .addEventListener("click", this._selectTabMouse.bind(this), !1),
          this._container.addEventListener(
            "keyup",
            function(t) {
        ...
        if (
          ...
          var n = e.getAttribute("data-content"),
            s = this._container.querySelector(
              ".ms-Pivot-content[data-content='" + n + "']"
            );
  ...
  var t = (function() {
    ...
    return (
      ...
      (e.prototype.cacheDOM = function() {
        (this._itemName =
          this.container.querySelector(".ms-ProgressIndicator-itemName") ||
          null),
    ...
    i = (function() {
      ...
      return (
        ...
        (e.prototype._setTargetElement = function() {
          this._target.className.indexOf("ms-Spinner") === -1
        ...
        (e.prototype._initializeOpacities = function() {
          var e,
            ...
            i = 1;
          for (
            this.fadeIncrement = 1 / this.numCircles, t;
            t < this.numCircles;
            t++
          ) {
        ...
        (e.prototype._createCirclesAndArrange = function() {
          for (
            var e,
              i = 0,
              n = this.parentSize * this.offsetSize,
              s = (2 * Math.PI) / this.numCircles,
              o = this.numCircles,
              r = 0.5 * (this.parentSize - n);
            o--;
            ...
            var a = this._createCircle(),
              c =
                Math.round(
                  0.5 * this.parentSize + r * Math.cos(i) - 0.5 * a.clientWidth
                ) -
                0.5 * n,
              l =
                Math.round(
                  0.5 * this.parentSize + r * Math.sin(i) - 0.5 * a.clientHeight
                ) -
                0.5 * n;
...
!(function(e) {
  ...
  var t = (function() {
    function e(e) {
      (this.container = e),
        this.container.className.indexOf("ms-Table--selectable") !== -1 &&
          this._addListeners();
    }
    return (
      (e.prototype._addListeners = function() {
  ...
  var i = (function() {
    ...
    return (
      (e.prototype._setTextFieldType = function() {
        this._container.classList.contains("ms-TextField--placeholder") &&
