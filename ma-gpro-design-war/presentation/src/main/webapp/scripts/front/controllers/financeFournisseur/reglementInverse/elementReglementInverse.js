...
angular
    .module('gpro.elementReglementInverseAchat', [])
    .controller(
        'ElementReglementInverseAchatController', [
        '$scope',
        '$http',
        '$log',
        '$filter',
        ...
        function ($scope, $http, $log, $filter,
             ...
             * par detail reglement au niveau de la partie back-end "/elementReglementInverseAchat/rechercheMulticritere"**/
            ...
            $scope.rechercheReglement = function (reglementCourante) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/elementReglementInverseAchat/rechercheMulticritere",
                        reglementCourante)
            ...
            $scope.modifierOuCreerReglement = function () {
                ...
                $http
                    .get(
                        UrlAtelier +
                        "/elementReglementInverseAchat/getById:" +
            ...
            $scope.updateReglement = function (reglement) {
                ...
                $http
                    .put(
                        UrlAtelier +
                        "/elementReglementInverseAchat/update",
                        reglement)
                    .success(
            ...
            $scope.creerReglement = function (reglement) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/elementReglementInverseAchat/create",
                        reglement)
                    .success(
            ...
            $scope.supprimerReglement = function () {
                ...
                $http({
                    method: "DELETE",
                    url: UrlAtelier +
                        "/elementReglementInverseAchat/delete:" +
...
/*            //generer rapport de tous les Reglement : List
            $scope.downloadAllReglementss = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementInverseAchatList?partieIntId=" + reglementCourante.partieIntId
...
/*
            ...
            $scope.downloadReglement = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementInverseAchat?id=" + reglementCourante.id + "&type=pdf";
