angular
.module('gpro.bondelivraisonFacon', [ "ngResource" ])
.controller(
		'bonlivraisonControllerFacon',
		[
		 '$scope',
		 '$filter',
		 '$http',
		 ...
		 function($scope, $filter, $http, $log, downloadService, UrlCommun, UrlAtelier, BonLivraisonServices,traitementFaconServices ) {
			...
			// Liste des traitements façon (hors cache)
			 ...
			 $scope.rechercherBonLivraisonVente = function(bonLivraisonVenteCourant) {
				...
				bonLivraisonVenteCourant.natureLivraison = "FACON";
				 $log.debug("----Request : bonLivraisonVenteCourant : recherche avant---"+ JSON.stringify(bonLivraisonVenteCourant, null, " "));
