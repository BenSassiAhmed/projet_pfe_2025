'use strict'
 ...
 angular
.module('atelier.production', [ "ngResource" ])
.controller(
				...
				function($scope, $filter, $http, $log, downloadService, UrlCommun, UrlAtelier) {
					 $log.info("=========Production========");
                          ...
                          $scope.listControlePESInit = [     {//PH
                            ...
                            //getListRefMiseFS
                            $scope.getListRefMiseFS = function() {
                                $log.debug("---get listFicheSuiveuse ref..");
                                $http
                                    .get(UrlAtelier + "/ficheSuiveuse/getListRefMiseFS")
                                    .success(
                                        function(data) {
                                      	  
                                          $scope.listRefMiseFS = data;
                                          $log.debug("-------listeFicheSuiveuses length : " +JSON.stringify( $scope.listRefMiseFS,null,""));
                                        });
                              }
                            
                            $scope.getListRefMiseFS();
                          ...
                          //Init data list
                            ...
                            $scope.rechercherFiche = function(ficheCourante) {
                            	console.log("---------- Liste des fiches - table ---------");                         
                            	//$log.debug("---Recherche $scope.ficheCourante:  "+JSON.stringify($scope.ficheCourante, null, "  "));
                                   //$log.debug("---log.debug Recherche ficheCourante:  "+JSON.stringify(ficheCourante, null, "  "));
                                   console.log("---console.log Recherche ficheCourante:  "+JSON.stringify(ficheCourante, null, "  "));
                                  
                                  $http.post(
                                                 UrlAtelier
                                                               + "/ficheSuiveuse/rechercheMulticritere",
                                                               ficheCourante)
                                                 .success(
                                                               function(resultat) {
                                                                      ...
                                                                      console.log("---Resultat ficheCourante:  "+JSON.stringify($scope.myData, null, "  "));
                                                                      ...
                                                                      $log.debug("listeFiche : "+ resultat.list.length);
                            ...
                            $scope.modifierOuCreerFicheSuiveuse = function() {
                           ...
                           //init subListOperation
                            ...
                            $scope.listControlePreparation = [];
                                  ...
                                  $log.debug("ModifierOuCreer id: "+$scope.myData[index].id);
                                    
                                  // getFicheSuiveuse
                                  $http
                                          .get( UrlAtelier
                                                        + "/ficheSuiveuse/getById:" + $scope.myData[index].id)
                                          .success(
                                                 function(ficheSuiveuse) {
                                                      
                                                      $log.debug("ficheSuiveuse : getById : "+ JSON.stringify(ficheSuiveuse,null, "  ") );
                                                      
                                                      //Mise : reference
                                                        $log.debug("***Mise Reference : "+ficheSuiveuse.referenceMise);
                                                        $scope.resultatRechercheMise.referenceMise = ficheSuiveuse.referenceMise;

                                                      //Mise: poids
                                                        $log.debug("***Mise poids : "+ficheSuiveuse.poids);
                                                        $scope.resultatRechercheMise.poids = ficheSuiveuse.poids;

                                                      //Produit :produitId
                                                        $log.debug("***TissuId : " + ficheSuiveuse.produitId );
                                                        $scope.resultatRechercheMise.produitId = ficheSuiveuse.produitId;
                                                     
                                                      /**conversion Produit **/
                                                      /*Methode 1: utilise le service getId pour convertir le produit avec l'Id x à sa propre reference
                                                       */
                                                      if(ficheSuiveuse.produitId!= null){
                                                        $http
                                                        .get(
                                                            UrlCommun
                                                                + "/produit/getId:"+ ficheSuiveuse.produitId)
                                                        .success(
                                                            function(datagetProduit) {
                                                              $log.debug(" --TissuId : " + datagetProduit.id);
                                                              $log.debug(" --TissuReference : " + datagetProduit.reference);
                                          ...
                                          $log.debug("-- AFTER  $scope.ficheCourante : "+JSON.stringify($scope.ficheCourante, null, "    ") );
                            ...
                            // Soustraire Stock
                            $scope.soustraireStock = function(ficheSuiveuse) {

                            	var listMouvementsTemp = [];
                            	
                            	//Liste Preparation
                            	angular.forEach($scope.listeTraitementMisePreparation, function(elementOperationPreparation, key){
                                    
                                      angular.forEach(elementOperationPreparation.listElementRecetteMise, function(elementRecette, key2){
                                    	  
                                    	  var mouvementTemp = {};
                                    	  
                                    	  $log.debug("------elementRecette : "+ JSON.stringify(elementRecette, null, " "));
                                    	  
                                    	  mouvementTemp.idArticle= elementRecette.articleId;
                                    	  mouvementTemp.type = "SORTIE",
                                    	  mouvementTemp.quantiteReelle = elementRecette.poids,
                                    	  
                                    	  
                                    	  listMouvementsTemp.push(mouvementTemp);
                                      	});
                            	...
                            	angular.forEach($scope.listeTraitementMiseTeinturePES, function(elementOperationTeinturePES, key){
                                    ...
                                    angular.forEach(elementOperationTeinturePES.listElementRecetteMise, function(elementOperationTeinturePES, key2){
                                  	  
                                  	  var mouvementTemp = {};
                                  	  
                                  	$log.debug("------TeinturePES : "+ JSON.stringify(elementOperationTeinturePES, null, " "));
                                  	  
                                  	  mouvementTemp.idArticle= elementOperationTeinturePES.articleId;
                                  	  mouvementTemp.type = "SORTIE",
                                  	  mouvementTemp.quantiteReelle = elementOperationTeinturePES.poids,
                            	...
                            	angular.forEach($scope.listeTraitementsMiseTeintureCoton, function(elementOperationTeintureCoton, key){
                                    ...
                                    angular.forEach(elementOperationTeintureCoton.listElementRecetteMise, function(elementOperationTeintureCoton, key2){
                                  	  
                                  	  var mouvementTemp = {};
                                  	  
                                  	$log.debug("------Teinture-coton : "+ JSON.stringify(elementOperationTeintureCoton, null, " "));
                                  	  
                                  	  mouvementTemp.idArticle= elementOperationTeintureCoton.articleId;
                                  	  mouvementTemp.type = "SORTIE",
                                  	  mouvementTemp.quantiteReelle = elementOperationTeintureCoton.poids,
                            	...
                            	angular.forEach($scope.listeTraitementsMiseFinissage, function(elementOperationFinissage, key){
                                    ...
                                    angular.forEach(elementOperationFinissage.listElementRecetteMise, function(elementOperationFinissage, key2){
                                  	  
                                  	  var mouvementTemp = {};
                                  	  
                                  	$log.debug("------Finissage : "+ JSON.stringify(elementOperationFinissage, null, " "));
                                  	  
                                  	  mouvementTemp.idArticle= elementOperationFinissage.articleId;
                                  	  mouvementTemp.type = "SORTIE",
                                  	  mouvementTemp.quantiteReelle = elementOperationFinissage.poids,
                            	...
                            	var bonMouvementStock = {
                            		
                            		type : "SORTIE",
                            		numero :$scope.resultatRechercheMise.referenceMise,
                            		date : $scope.ficheCourante.dateLancement,
                            		raisonMouvementId : 51 ,
                            		soustractionSortie : true,
                            		idMagasin :1,
//                            		origineFSuiveuse :true,
                            		mouvements : listMouvementsTemp 
                            	};
								$log.debug("Objet Créé bon mouvement sortie : " + JSON.stringify(bonMouvementStock,null,"  "));
								...
								$log.debug("-----creerBonMouvementStock success : " + JSON.stringify(bonMouvementStock,null,"  "));
								$log.debug("-----creerBonMouvementStock success : $scope.ficheCourante " + JSON.stringify( $scope.ficheCourante,null,"  "));

								/*-----------update Fiche suiveuse------------------*/
								
								$scope.ficheCourante.soustractionEffectuee = true;
	                            $log.debug("-- soustraction update FS : OBJ ficheSuiveuse--- : "+JSON.stringify($scope.ficheCourante, null, "    ") );
	                            
	                                   $http  .post( UrlAtelier + "/ficheSuiveuse/update",   $scope.ficheCourante)
	                                          .success(
                            ...
                            $log.debug("-- OBJ modifié ficheSuiveuse--- : "+JSON.stringify(ficheSuiveuse, null, "    ") );
...
//                             
                             ...
                             // ficheSuiveuse.listElementRecetteMise = listElementRecetteMiseTmp ;
                              ...
                              ficheSuiveuse.listeTraitementsMise = listeTraitementsMiseTmp;
                                  ...
                                  $log.debug("-- OBJ  à crée ficheSuiveuse: "+JSON.stringify(ficheSuiveuse, null, "    ") );
                                                        ...
                                                        $http  .get(UrlAtelier + "/ficheSuiveuse/getById:"
                                                               ...
                                                               .success(
                                                                      function(dataGetFicheSuiveuse) {
                                                                             ...
                                                                             $log.debug("----dataGetFicheSuiveuse success create-----: " + JSON.stringify(dataGetFicheSuiveuse,null,"  ") );
                                                                             // bouton PDF activé
                                                                             $scope.modePdf = "actif";
            ...
            // --------- Finissage
                          /** Mode Creation **/
                           ...
                           $scope.saveControleFinissage = function(data, id) {
                            ...
                            //generer rapport apres creation d'une ficheSuiveuse. mode : Modification/Consultation
                            ...
                            $scope.colDefs = [
                                   ...
                                   },
                                   {
                                          ...
                                          cellTemplate : '<div class="buttons" ng-show="!rowform.$visible">'
                                                 +'<button data-nodrag class="btn btn-default btn-xs" ng-click="modifierOuCreerFicheSuiveuse()"> <i class="fa fa-fw fa-pencil"></i></button>'
                                                 + '<button data-nodrag class="btn btn-default btn-xs" ng-click="showPopupDelete(8)" ng-disabled=""><i class="fa fa-fw fa-trash-o"></i></button></div>'
