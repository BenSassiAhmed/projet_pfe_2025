...
angular
    .module('gpro.elementReglementInverse', [])
    .controller(
        'ElementReglementInverseController', [
        '$scope',
        '$http',
        '$log',
        '$filter',
        ...
        function ($scope, $http, $log, $filter,
             ...
             * par detail reglement au niveau de la partie back-end "/elementReglementInverse/rechercheMulticritere"**/
            ...
            $scope.rechercheReglement = function (reglementCourante) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/elementReglementInverse/rechercheMulticritere",
                        reglementCourante)
            ...
            $scope.modifierOuCreerReglement = function () {
                ...
                $http
                    .get(
                        UrlAtelier +
                        "/elementReglementInverse/getById:" +
            ...
            $scope.updateReglement = function (reglement) {
                ...
                $http
                    .put(
                        UrlAtelier +
                        "/elementReglementInverse/update",
                        reglement)
                    .success(
            ...
            $scope.creerReglement = function (reglement) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/elementReglementInverse/create",
                        reglement)
                    .success(
            ...
            $scope.supprimerReglement = function () {
                ...
                $http({
                    method: "DELETE",
                    url: UrlAtelier +
                        "/elementReglementInverse/delete:" +
     ...
     /*       $scope.downloadAllReglements = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementInverseList?partieIntId=" + reglementCourante.partieIntId
            ...
            $scope.downloadReglement = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementInverse?id=" + reglementCourante.id + "&type=pdf";
