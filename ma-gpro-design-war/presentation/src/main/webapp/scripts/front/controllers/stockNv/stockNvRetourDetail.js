'use strict'
angular
	.module('gpro.stockNvRetourDetail', [])
	.controller(
		'stockNvRetourDetailController',
		[
			'$scope',
			'$http',
			'$filter',
			...
			//		var fileName = '  Liste Reception Achat Detail	'		;					
						...
						function () {
							$scope.colDefs = [
								...
								},
								{
									...
									displayName: 'Date Avoir',
									cellFilter: 'date:\'dd-MM-yyyy\'',
										width : '7%'
								},
								{
									field: 'receptionAchatValue.refAvoirRetour',
...

								{
										...
										width :'3%',
									cellTemplate: '<div ng-if="row.entity.serialisable == true"><button data-nodrag class="fa fa-barcode" ng-click="consulterNumSerie()" data-target="#SeriesModalConsult" data-toggle="modal"></button></div>'
								}/*,
														{
															field : '',
															width : '5%',
