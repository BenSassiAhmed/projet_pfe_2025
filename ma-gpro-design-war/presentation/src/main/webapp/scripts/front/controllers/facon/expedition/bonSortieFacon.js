'use strict'
 ...
 angular
.module('atelier.bonSortieFacon', [ "ngResource", "ngCsvImport"])
.controller(
              		'bonSortieControllerFacon',
              		[
              				'$scope',
              				'$filter',
              				'$http',
                        ...
                        $log.info(" listToAdd : "+JSON.stringify(listToAdd, null, "  "));
                                ...
                                width:'10%',
                                      ...
                                      +'<button data-nodrag class="btn btn-default btn-xs" ng-click="modifierOuCreerBonSortie()"> <i class="fa fa-fw fa-pencil"></i></button>'
              												...
              												+'<button class="btn btn-action2" ng-click="redirectToVente(row.entity.reference, row.entity.dateSortie )">BL</button></div>'} ];
              									});
              								$scope.filterOptions = {
              									filterText : "",
              											...
              											function() {
              												...
              												if (searchText) {
              													...
              													$http
              															.post(
              																	UrlAtelier
              																	+ "/bonsortiefini/rechercheMulticritere",bonSortieCourant)
              															.success(
              																	function(
              																			largeLoad) {
              																		data = largeLoad.list
