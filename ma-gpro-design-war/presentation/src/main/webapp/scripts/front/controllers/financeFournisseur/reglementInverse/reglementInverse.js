        	...
        	angular
        	    .module('gpro.reglementInversefournisseur', [])
        	    .controller(
        	        'ReglementInverseFournisseurController', [
        	            '$scope',
        	            '$http',
        	            '$log',
        	            '$filter',
            ...
            $scope.getListeBanquePI();
        	                ...
        	                $scope.rechercheReglement = function(reglementCourante) {
        	                    ...
        	                    $http
        	                        .post(
        	                            UrlAtelier +
        	                            "/reglementInverseAchat/rechercheMulticritere",
        	                            reglementCourante)
	...
	$http
        	            		.get(
        	            				UrlAtelier
        	            						+ "/reglementInverseAchat/getCurrentReferenceMensuelByDate:"+formattedDate(dateIntro)
        	            						)
        	            		.success(
        	            				function(res) {
...
//        	                   }
        	        ...
        	        //boutton valider les reglements
        	         $scope.Valider = function(clientID) {
        	                    ...
        	                    $http
        	                           .get(UrlAtelier
        	                                   + "/reglementInverseAchat/validateByFournisseurId:" +clientID)
        	                           .success(
        	                                   function(reglement) {
        	         ...
        	         $scope.ValiderGroupeClient = function(groupeClientId) {
        	                    ...
        	                    $http
        	                           .get(UrlAtelier
        	                                   + "/reglementInverseAchat/validateByGroupeFournisseurId:" +groupeClientId)
        	                           .success(
        	                                   function(reglement) {
        	                                          $scope.finalBLList = reglement.listLivraisonNonRegle;
        	                                          $scope.finalFacturesList = reglement.listFactureNonRegle;
