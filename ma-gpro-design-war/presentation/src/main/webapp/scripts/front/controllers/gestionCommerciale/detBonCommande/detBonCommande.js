'use strict'
angular
		.module('gpro.gcDetBonCommande', [])
		.controller(
				'detBonCommandeController',
				[
						'$scope',
						'$http',
						'$filter',
...
//										.copy(commande) : {};
							...
							$scope.rechercherCommandeVente = function(commandeVenteCourante){
								...
								$http
								.post(
										UrlAtelier+ "/produitCommande/rechercheMulticritere",
										commandeVenteCourante)
								.success(
										function(data) {
											
											$scope.myDataCommandeVente = data.listProduitCommandeValues;
										});
							}
							...
							function formattedDate(date) {
							 ...
							 $scope.dowloadListCmdvente = function (commandeAchatCourante) 
                             {
                                ...
                                $http({
                                    url: UrlAtelier + "/fiches/listProduitCommandesVente",
                                    method: "POST",
                                    data: commandeAchatCourante,
                                     // this is your json
                                                                    // data string
                                    headers: {
                                    ...
                                    var fileName = 'liste_Des_Produits_De_Commandes_Vente' + formattedDate(new Date());
								...
								'myDataCommandeVente',
									...
									$scope.colDefs = [
										/*	{
											...
											{
												field : 'montantRemise',
												displayName : 'montantRemise',
											//	width:'10%'
											},
											{
												field : 'montantHTTotal',
												...
												if (searchText) {
													...
													$http
															...
															.success(
																	function(
																			largeLoad) {
																		$scope.myDataCommandeVente = largeLoad.listProduitCommandeValues
																				.filter(function(
																						item) {
																					return JSON
																							.stringify(
													...
													$http
															...
															.success(
																	function(
																		...
																		$scope
																				.setPagingData(
																						largeLoad.listProduitCommandeValues,
																						page,
																						pageSize);
																	});
												}
