'use strict'
angular
		.module('gpro.manageSociete', [ "ngResource" ])
		.controller(
				'manageSocieteController',
				[
						'$scope',
						'$filter',
						'$http',
						...
						function($scope, $filter, $http, $log, downloadService, UrlCommun,UrlAtelier) {
							...
							$scope.listePartieInteressee = function() {
								$http.get(UrlCommun + "/societe/all")
