...
(function (window, document, undefined) {
  ...
  */
  ...
  function LocationHashbangUrl(appBase, hashPrefix) {
     ...
     */
    this.$$parse = function (url) {
      var withoutUrlCommun = beginsWith(appBase, url) || beginsWith(appBaseNoFile, url);
      var withoutHashUrl = withoutUrlCommun.charAt(0) == '#'
        ? beginsWith(hashPrefix, withoutUrlCommun)
        : (this.$$html5)
          ? withoutUrlCommun
          : '';
