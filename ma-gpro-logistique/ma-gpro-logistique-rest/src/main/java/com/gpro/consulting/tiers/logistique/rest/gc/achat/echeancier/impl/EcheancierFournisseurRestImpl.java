package com.gpro.consulting.tiers.logistique.rest.gc.achat.echeancier.impl;
 ...
 */
@RestController
@RequestMapping("/echeancierFournisseur")
public class EcheancierFournisseurRestImpl {
	
	private static final Logger logger = LoggerFactory.getLogger(EcheancierFournisseurRestImpl.class);
	
	@Autowired
	private IEcheancierFournisseurService echeancierService;
