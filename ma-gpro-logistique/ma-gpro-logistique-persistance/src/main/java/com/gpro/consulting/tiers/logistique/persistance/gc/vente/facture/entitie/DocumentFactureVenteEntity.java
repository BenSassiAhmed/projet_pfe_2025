 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_FACTURE_VENTE)
public class DocumentFactureVenteEntity implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8559166183360011712L;

	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENT_FACTUREVENTE_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_CDOCFV_SEQ)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENT_FACTUREVENTE_ID_GENERATOR")
	private Long id;
