 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_REGLEMENT_INVERSE_ACHAT)
public class DocumentReglementInverseAchatEntity implements Serializable {


	/** The Constant serialVersionUID. */


	private static final long serialVersionUID = -4031802687748790395L;

	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENT_REGLEMENT_INVERSE_ACHAT_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_DOCUMENTS_REGLEMENT_INVERSE_ACHAT)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENT_REGLEMENT_INVERSE_ACHAT_ID_GENERATOR")
	private Long id;
    ...
    private ReglementInverseAchatEntity reglement;
	...
	public ReglementInverseAchatEntity getReglement() {
		return reglement;
	}
	...
	public void setReglement(ReglementInverseAchatEntity reglement) {
