 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_REGLEMENT)
public class DocumentReglementEntity implements Serializable {
	...
	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENT_REGLEMENT_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_DOCUMENTS_REGLEMENT)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENT_REGLEMENT_ID_GENERATOR")
	private Long id;
