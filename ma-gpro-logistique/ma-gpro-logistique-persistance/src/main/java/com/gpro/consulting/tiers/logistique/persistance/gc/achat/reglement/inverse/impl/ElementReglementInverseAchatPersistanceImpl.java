...
@Component
public class ElementReglementInverseAchatPersistanceImpl extends AbstractPersistance implements IElementReglementInverseAchatPersistance{

	private static final Logger logger = LoggerFactory.getLogger(ElementReglementInverseAchatPersistanceImpl.class);
	...
	public List<ElementReglementAchatValue> getByRefernceFacture(String refernceFacture) {
		...
		if (estNonVide(refernceFacture)) {
			...
			CriteriaQuery<ElementReglementInverseAchatEntity> criteriaQuery = criteriaBuilder.createQuery(ElementReglementInverseAchatEntity.class);
			List<Predicate> whereClause = new ArrayList<Predicate>();
			Root<ElementReglementInverseAchatEntity> root = criteriaQuery.from(ElementReglementInverseAchatEntity.class);
		    ...
		    List <ElementReglementInverseAchatEntity> resultatEntite = this.entityManager.createQuery(criteriaQuery).getResultList();
		    
		    for (ElementReglementInverseAchatEntity entity : resultatEntite) {
		    	ElementReglementAchatValue element = ReglementInverseAchatPersistanceUtilities.toValue(entity);
	...
	public ResultatRechecheElementReglementAchatValue rechercherMultiCritere(RechercheMulticritereReglementAchatValue request) {
		...
		//reference reglement
			...
			if (estNonVide(request.getReference())) {
				...
				Join<ElementReglementInverseAchatEntity,ReglementAchatEntity> jointure_elementReglement_reglement = root.join(PREDICATE_REGLEMENT);
	    ...
	    for (ElementReglementInverseAchatEntity entity : resultatEntite) {
	    	ResultatRechecheElementReglementAchatElementValue element = ReglementInverseAchatPersistanceUtilities.toValueElementReglementAffichage(entity);
	...
	public void deleteElementReglementById(Long id) {
		this.supprimerEntite(ElementReglementInverseAchatEntity.class, id);
