...
@Component
public class DetailsReglementInverseAchatPersistanceImpl extends AbstractPersistance implements IDetailsReglementInverseAchatPersistance{

	private static final Logger logger = LoggerFactory.getLogger(DetailsReglementInverseAchatPersistanceImpl.class);
	...
	public ResultatRechecheElementReglementAchatValue rechercherMultiCritere(RechercheMulticritereReglementAchatValue request) {
		...
		//reference reglement
			...
			if (estNonVide(request.getReference())) {
				...
				Join<DetailsReglementInverseAchatEntity,ReglementAchatEntity> jointure_detailsReglement_reglement = root.join(PREDICATE_REGLEMENT);
	    ...
	    for (DetailsReglementInverseAchatEntity entity : resultatEntite) {
	    	ResultatRechecheElementReglementAchatElementValue element = ReglementInverseAchatPersistanceUtilities.toValueDetailsReglementAffichage(entity);
	...
	public String update(DetailsReglementAchatValue detailsReglementValue) {
		DetailsReglementInverseAchatEntity entity = (DetailsReglementInverseAchatEntity) this.modifier(ReglementInverseAchatPersistanceUtilities.toEntity(detailsReglementValue));
