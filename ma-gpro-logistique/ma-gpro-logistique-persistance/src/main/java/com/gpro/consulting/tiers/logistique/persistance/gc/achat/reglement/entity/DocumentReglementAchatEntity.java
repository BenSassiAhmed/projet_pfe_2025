 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_REGLEMENT_ACHAT)
public class DocumentReglementAchatEntity implements Serializable {
	...
	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENT_REGLEMENT_ACHAT_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_DOCUMENTS_REGLEMENT_ACHAT)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENT_REGLEMENT_ACHAT_ID_GENERATOR")
	private Long id;
