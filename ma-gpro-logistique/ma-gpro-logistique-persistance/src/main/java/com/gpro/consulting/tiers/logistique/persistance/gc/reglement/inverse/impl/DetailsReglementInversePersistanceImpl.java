...
@Component
public class DetailsReglementInversePersistanceImpl extends AbstractPersistance implements IDetailsReglementInversePersistance{

	private static final Logger logger = LoggerFactory.getLogger(DetailsReglementInversePersistanceImpl.class);
	...
	public ResultatRechecheElementReglementValue rechercherMultiCritere(RechercheMulticritereReglementValue request) {
		...
		//reference reglement
			...
			if (estNonVide(request.getReference())) {
				...
				Join<DetailsReglementInverseEntity,ReglementEntity> jointure_detailsReglement_reglement = root.join(PREDICATE_REGLEMENT);
	    ...
	    for (DetailsReglementInverseEntity entity : resultatEntite) {
	    	ResultatRechecheElementReglementElementValue element = ReglementInversePersistanceUtilities.toValueDetailsReglementAffichage(entity);
	...
	public ResultBestElementValue rechercherMultiCritereReglementEchusDuJours(Calendar instance, boolean b,
		...
		if (estNonVide(boutiqueId)) {
		 ...
		 Query vQuery = this.entityManager.createQuery(
			      ...
			      +" from DetailsReglementInverseEntity det "
				...
				public DetailsReglementValue getById(Long detailReglementId) {
					DetailsReglementInverseEntity entity = this.rechercherParId(detailReglementId, DetailsReglementInverseEntity.class);
				...
				public String update(DetailsReglementValue detailsReglementValue) {
					DetailsReglementInverseEntity entity = (DetailsReglementInverseEntity) this.modifier(ReglementInversePersistanceUtilities.toEntity(detailsReglementValue));
