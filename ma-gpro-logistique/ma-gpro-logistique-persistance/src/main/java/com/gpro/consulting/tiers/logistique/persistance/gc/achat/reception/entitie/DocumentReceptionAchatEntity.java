 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_RECEPTIONACHAT)
public class DocumentReceptionAchatEntity implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 732346593864860043L;

	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENTS_RECEPTIONACHAT_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_DOCUMENTS_RECEPTIONACHAT)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENTS_RECEPTIONACHAT_ID_GENERATOR")
	private Long id;
