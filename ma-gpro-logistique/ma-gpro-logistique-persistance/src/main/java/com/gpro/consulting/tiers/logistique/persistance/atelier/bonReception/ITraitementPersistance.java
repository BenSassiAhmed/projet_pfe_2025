 ...
 * @author Ameni
 */
public interface ITraitementPersistance {
	
	/**
	   * Méthode de création d'un traitement et de l'inserer dans la base de données retournant l'id de l'objet entité.
	   * 
	  ...
	  /**
	   * Méthode de modification d'un traitement par id retournant l'id de l'objet entité.
	   * 
	   * @param pTraitement
	   * @return vId
	   */
