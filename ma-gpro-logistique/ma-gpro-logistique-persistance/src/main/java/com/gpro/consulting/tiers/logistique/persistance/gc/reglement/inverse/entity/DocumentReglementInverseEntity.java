 ...
 */
@Entity
@Table(name=IConstanteCommerciale.TABLE_GC_DOCUMENTS_REGLEMENT_INVERSE)
public class DocumentReglementInverseEntity implements Serializable {
	...
	/** The id. */
	@Id
	@SequenceGenerator(name="DOCUMENT_REGLEMENT_INVERSE_ID_GENERATOR", sequenceName=IConstanteCommerciale.SEQUENCE_GC_DOCUMENTS_REGLEMENT_INVERSE)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DOCUMENT_REGLEMENT_INVERSE_ID_GENERATOR")
	private Long id;
