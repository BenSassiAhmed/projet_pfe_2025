 ...
 *
 */
public class ComptoirVenteValue implements Comparable<ComptoirVenteValue> {
	...
	private List<DetComptoirVenteValue> listDetComptoirVente;
	...
	public int compareTo(ComptoirVenteValue element) {
	...
	public List<DetComptoirVenteValue> getListDetComptoirVente() {
		return listDetComptoirVente;
	}

	public void setListDetComptoirVente(List<DetComptoirVenteValue> listDetComptoirVente) {
	...
	public String toString() {
		return "LivraisonVenteValue [id=" + id + ", reference=" + reference + ", date=" + date + ", montantHTaxe="
				...
				+ dateModification + ", version=" + version + ", listDetLivraisonVente=" + ", modifier=" + modifier
				+ ", modepaiementId=" + modepaiementId + ", marcheId=" + marcheId + ", modepaiement=" + modepaiement
				+ ", marche=" + marche + ", natureLivraison=" + natureLivraison + ", totalPourcentageRemise="
