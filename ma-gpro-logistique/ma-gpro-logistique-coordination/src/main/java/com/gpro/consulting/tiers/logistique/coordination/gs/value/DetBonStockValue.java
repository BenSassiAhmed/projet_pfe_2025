 ...
 *
 */
public class DetBonStockValue implements Comparable<DetBonStockValue> {
	...
	@Override
	public int compareTo(DetBonStockValue o) {
		DetBonStockValue element = (DetBonStockValue) o;
	...
	public Long getBonStockId() {
		return bonStockId;
	}

	public void setBonStockId(Long bonStockId) {
		this.bonStockId = bonStockId;
	}
