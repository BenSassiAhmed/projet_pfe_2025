 ...
 *
 */
public class FactureAchatReportTraitementFaconValue implements Comparable<FactureAchatReportTraitementFaconValue> {
	...
	@Override
	public int compareTo(FactureAchatReportTraitementFaconValue o) {
		FactureAchatReportTraitementFaconValue element = (FactureAchatReportTraitementFaconValue) o;
