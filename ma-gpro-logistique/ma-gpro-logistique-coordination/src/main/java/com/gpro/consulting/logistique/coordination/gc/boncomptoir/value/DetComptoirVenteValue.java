 ...
 *
 */
public class DetComptoirVenteValue implements Comparable<DetComptoirVenteValue> {
	...
	@Override
	public int compareTo(DetComptoirVenteValue o) {
		DetComptoirVenteValue element = (DetComptoirVenteValue) o;
	...
	public Long getComptoirVenteId() {
		return comptoirVenteId;
	}

	public void setComptoirVenteId(Long comptoirVenteId) {
		this.comptoirVenteId = comptoirVenteId;
	}
	...
	public String toString() {
		return "DetLivraisonVenteValue [id=" + id + ", produitId=" + produitId + ", quantite=" + quantite + ", unite="
				+ unite + ", nombreColis=" + nombreColis + ", livraisonVenteId=" + ", remise=" + remise
				+ ", produitDesignation=" + produitDesignation + ", produitReference=" + produitReference
